    ...
    <div style={{ minHeight: '100vh', background: '#000', color: '#fff', fontFamily: 'system-ui' }}>
      ...
      <main style={{ maxWidth: 960, margin: '40px auto', padding: '0 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(240px,1fr))', gap: 16, marginTop: 32 }}>
          <div style={{ background: 'rgba(255,255,255,.03)', border: '1px solid rgba(0,255,255,.15)', borderRadius: 16, padding: 24 }}>
            <h3 style={{ color: '#00FFFF', fontSize: 16 }}>Mi Suscripción</h3>
            <p style={{ color: '#888', fontSize: 13, marginTop: 8 }}>Gestiona tu plan y facturación.</p>
          ...
          <div style={{ background: 'rgba(255,255,255,.03)', border: '1px solid rgba(191,0,255,.15)', borderRadius: 16, padding: 24 }}>
          ...
          <div style={{ background: 'rgba(255,255,255,.03)', border: '1px solid rgba(57,255,20,.15)', borderRadius: 16, padding: 24 }}>
            <h3 style={{ color: '#39FF14', fontSize: 16 }}>Ayuda</h3>
